# SOS-CLIENT-LOCATIONS-STATE – Client Locations: State/Territory Column Not Displaying
...
User is logged into the application and has access to the Client module.
