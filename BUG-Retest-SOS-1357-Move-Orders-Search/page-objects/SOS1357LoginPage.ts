...
export class SOS1357LoginPage extends BasePage {
  ...
  // Top navigation — indicates the app shell has loaded
  ...
  async verifyAuthenticated(): Promise<void> {
    this.log('Waiting for redirect to application shell...');
    // Wait for the "Finishing sign-in" redirect to complete — up to 30 s
